...
* ``lazySizesConfig.addClasses`` (default: ``false``): Wether lazysizes should add loading and loded classes. This can be used to add unveil effects or to apply new styles (background-image).
